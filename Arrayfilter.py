...
If the value at an index is True that element is
contained in the filtered array, if the value at that index is
...
The above example is quite a common task in NumPy
and NumPy provides a nice way to tackle it.
